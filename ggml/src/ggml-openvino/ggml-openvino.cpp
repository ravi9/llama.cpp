...
static bool ggml_backend_openvino_device_supports_op(ggml_backend_dev_t dev, const ggml_tensor * op) {
    ...
    static const std::set<ggml_op> supported_ops{
        GGML_OP_NONE,    GGML_OP_ADD,      GGML_OP_MUL,       GGML_OP_MUL_MAT,        GGML_OP_VIEW, GGML_OP_CONT,
        GGML_OP_RESHAPE, GGML_OP_PERMUTE,  GGML_OP_TRANSPOSE, GGML_OP_GET_ROWS,       GGML_OP_ROPE, GGML_OP_RMS_NORM,
        GGML_OP_SCALE,   GGML_OP_SOFT_MAX, GGML_OP_SET_ROWS,  GGML_OP_FLASH_ATTN_EXT, GGML_OP_CPY};
