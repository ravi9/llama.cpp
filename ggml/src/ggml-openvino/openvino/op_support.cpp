...
//
// Everything here was moved from is_op_supported_case() in ggml-openvino.cpp,
...
//
// rules moved from is_op_supported_case() in ggml-openvino.cpp
//
...
static const OpEntry * openvino_op_entry(const ggml_tensor * op) {
    static const auto & table = get_supported_ops();
