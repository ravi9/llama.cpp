...
public:
    ...
    virtual Shape get_input_ggml_shape(int node_idx, const std::string & name) const = 0;

    virtual std::vector<size_t> get_input_ggml_stride(int node_idx, const std::string & name) const = 0;

    virtual int32_t get_input_dynamic_dim(int node_idx, const std::string & name) const = 0;

    virtual size_t get_input_type_size(int node_idx, const std::string & name) const = 0;

    virtual int64_t get_input_block_size(int node_idx, const std::string & name) const = 0;

    virtual bool input_has_same_shape_as_output(int node_idx, const std::string & name) const = 0;

    virtual bool input_is_none_op(int node_idx, const std::string & name) const = 0;

    virtual bool input_has_org_src(int node_idx, const std::string & name) const = 0;
    ...
    virtual Shape get_output_ggml_shape(int node_idx) const = 0;

    virtual std::vector<size_t> get_output_ggml_stride(int node_idx) const = 0;

    virtual size_t get_output_type_size(int node_idx) const = 0;
